...
class TTextTheme {
  ...
  static TextTheme lighttexttheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 22.0, fontWeight: FontWeight.w600, color: TColors.dark),
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: TColors.dark),
    bodySmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w500, color: TColors.dark.withOpacity(0.5)),
  ...
  static TextTheme darktexttheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 22.0, fontWeight: FontWeight.w600, color: TColors.light),
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: TColors.light),
    bodySmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w500, color: TColors.light.withOpacity(0.5)),
    // bodynewsmall:const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w500, color: TColors.light.withOpacity(0.5)),
    // bodynewmedium:const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: TColors.light),
